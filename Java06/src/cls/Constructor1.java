...
public class Constructor1 {
	public static void main(String[] args) {
		...
		// 생성자 : 사람이 초기값을 입력하지 않으면 실행이 안되게끔 해버리는 문법(반드시 초기값을 입력하게끔 해놓는 문접)
...
class MyClass9Test{
	public void test(MyClass9 mc) {
		if(mc.getAge() < 13) {
			...
			System.out.println(mc.getName()+"은(는) 탑승가능! 축하링");
		}
	}
}
